...
// Copilar: gcc main.c tabela_hash.c -o hash_test
// Executar: ./hash_test

/*
Infelizmente, tive de apelar para IA nesse
exercício, pois estava com dificuldades para
implementar a função e entender
*/